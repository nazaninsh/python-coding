...
'''
#we wanna search for numbers so we use \d and also we wanna search for ages
#that have digits between 1 and 3 so we use: {1,3}
...
#second parameter is where we wanna search for the re? in the target exampleString
